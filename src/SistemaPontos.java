        ...
        switch (caso.charAt(0)) {
            case '1':
                ...
                switch (pontosAdicionar.charAt(0)){
                    case '1': aluno.setPontos(aluno.getPontos() + 3);
                    System.out.println("Pontos adicionados com sucesso. Pontos totais: " + aluno.getPontos());
                        msg.menu();
                    break;
            case '2': aluno.setPontos(aluno.getPontos() + 2);
                System.out.println("Pontos adicionados com sucesso. Pontos totais: " + aluno.getPontos());
                msg.menu();
                break;
        case '3': aluno.setPontos(aluno.getPontos() + 5);
        System.out.println("Pontos adicionados com sucesso. Pontos totais: " + aluno.getPontos());
            msg.menu();
            break;
                    case '4': aluno.setPontos(aluno.getPontos() + 8);
                        System.out.println("Pontos adicionados com sucesso. Pontos totais: " + aluno.getPontos());
                        msg.menu();
                        break;
                    default:
